...
const HISTORY_ARCHIVE_METHOD_HELP='Löpararkivet använder endast verifierad personidentitet från U2. Namn, startnummer eller legacy athlete_id får aldrig ensamma länka en person mellan år. Alla verifierat länkade resultat visas, men sluttidsutveckling och bästa tid beräknas endast inom en uttryckligt verifierad whole-course-grupp. CourseVersion är ett checkpoint-/segmentkontrakt och räcker inte ensam som helbanebevis. Om ingen sådan grupp är verifierad visas målgångarna separat utan konstruerad tidstrend. DNF och DNS kan visas i personens tidslinje men ingår inte i sluttidsserier. Om personidentiteten inte är verifierad visar arkivet endast det enskilda publicerade resultatet.';
