...
function renderCourseIntelligence(existingModel=null){
  ...
  rowsEl.innerHTML=model.segments.map(segment=>{
    ...
    const range=field.sufficient_sample&&field.q10_pace_seconds_per_km!=null&&field.q90_pace_seconds_per_km!=null?`${nPace(field.q10_pace_seconds_per_km)}–${nPace(field.q90_pace_seconds_per_km)}`:'–';
