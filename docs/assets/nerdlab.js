...
const CLASS_HISTORY_METHOD_HELP='Klasshistorik har två separata lägen för att undvika dubbla axlar och överlastning. Mediantid visar median sluttid för fullföljande per vald klass. Deltagande visar alla faktiska startande i en stapel per klass och år, där den mörka delen är DNF; DNS räknas inte som startande. DNF-andelen beräknas som DNF/startande och visas tillsammans med antalet i tooltip. Bansträckningen har förändrats över historiken, så skillnader mellan år är beskrivande och inte ett bevis på ren prestationsutveckling.'; tekniska jämförbarhetsgränser visas inte som egna linjer i diagrammet. DNS räknas inte som startande; medianfart och sluttid bygger på fullföljande med giltig sluttid.';
