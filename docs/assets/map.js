...
const app={data:null,registry:null,models:[],time:0,maxTime:1,speed:'60s',playing:false,lastFrame:0,lastUi:0,lastCamera:0,lastBattle:0,prevTime:0,map:null,tileLayer:null,routeOnly:false,leafletReady:false,focused:null,project:null,usedRoutes:[],allCoords:[],audio:null,musicEnabled:true,duelElevation:null};
...
function duelPlaybackRate(maxTime,mode){const duration=Number(String(mode||'60s').replace(/s$/,''));return Number.isFinite(maxTime)&&maxTime>0&&DUEL_PLAYBACK_DURATIONS.includes(duration)?maxTime/duration:maxTime/60}
