...
const INFO_HELP_EXTENDED=[
  ...
  ['#classHistoryChart','Linjerna visar median sluttid för fullföljande mot vänster tidsaxel. De grupperade staplarna visar startande och DNF mot höger personaxel för varje vald klass och år. DNS räknas inte som startande. Medianlinjen ritas endast där två eller fler loppår ingår i samma uttryckligt verifierade helbaneserie; enstaka icke jämförbara medianvärden visas inte som fristående punkter. Deltagandestaplar kan fortsätta mellan loppår även när helbanans jämförbarhet saknas. Hovra eller fokusera en linjeposition eller stapel för exakt tid respektive antal.'],
