...
const INFO_HELP_EXTENDED=[
  ...
  ['#classHistoryChart','Linjerna visar median sluttid för fullföljande mot vänster tidsaxel. De grupperade staplarna visar startande och DNF mot höger personaxel. Medianlinjen binds samman mellan efterföljande tävlingsår som har data och bryts vid kalenderluckor utan lopp. Bansträckningen har förändrats över historiken, så nivåskillnader mellan år är beskrivande och ska inte tolkas som ren prestationsutveckling. DNS räknas inte som startande. Hovra eller fokusera en linjeposition eller stapel för exakt värde.'],
