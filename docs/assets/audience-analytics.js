...
if(typeof window!=='undefined'&&typeof document!=='undefined')(() => {
  ...
  function renderClassEvolution(){
    ...
    if(!model){model=api.aggregateClassHistory({races,results:filteredAcrossYears({ignoreClass:true}),getClass:r=>normClass(r.age_class),getGender:sexKey,isStarter,isFinished,comparisonKeyForRace:historyComparisonKey});advanced.classEvolutionCache.set(cacheKey,model)}
