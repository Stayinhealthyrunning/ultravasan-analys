    ...
    return `<div class="runner-replay" data-runner-replay style="--pace-fast:${PACE_COLORS[0]};--pace-even:${PACE_COLORS[2]};--pace-slow:${PACE_COLORS[4]}">
      <div class="runner-replay-toolbar">
        ...
        <div class="runner-replay-actions">
          ...
          <label>Hastighet<select data-replay-speed aria-label="Välj uppspelningshastighet"><option value="60s" selected>Hela loppet på 1 minut</option><option value="30s">Hela loppet på 30 sek</option><option value="60">60×</option><option value="10">10×</option><option value="1">1×</option></select></label>
