...
assert.ok(classEvolutionSourceU7.includes('comparisonBreaks')&&!classEvolutionSourceU7.includes("class:'class-evolution-course-break'")&&classEvolutionSourceU7.includes('from.comparisonKey!==to.comparisonKey'),'Klassutveckling ska behålla jämförbarhetslogik utan att rita tekniska vertikala brytlinjer');
