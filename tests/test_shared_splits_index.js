...
assert.ok(/(?:assets\/nerdlab\.js\?v=20260923-(?:u7|u8[a-z]*)|assets\/nerdlab\.js\?v=20260924-r3)/.test(indexHtml)&&indexHtml.includes('assets/class-evolution.js?v=20260923-u7')&&/(?:assets\/audience-analytics\.js\?v=20260923-(?:u7|u8[a-z]*)|assets\/audience-analytics\.js\?v=20260924-r3)/.test(indexHtml),'U7:s historik-UI-assets ska cache-bustas tillsammans');
